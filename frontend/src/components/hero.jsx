    ...
    <section className="bg-transparent my-0 mx-4 md:mx-12 lg:mx-20 relative overflow-visible">
      ...
      <div className="bg-white rounded-lg overflow-hidden">
        <div className="container mx-auto px-6 py-8 relative z-10">
          <div className="max-w-[1248px] w-full mx-auto flex flex-col md:flex-row items-center justify-center"> {/* Centered flex container */}
            {/* Left side content */}
            <div className="w-full md:w-1/2 mb-8 md:mb-0 flex flex-col items-start justify-center"> {/* Centering adjustments */}
